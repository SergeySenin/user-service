...
# Пример: POSTGRES_TAG=16.4 ./install.sh

# Основные образы приложения и окружения
readonly POSTGRES_TAG="${POSTGRES_TAG:-16.3}"
readonly REDIS_TAG="${REDIS_TAG:-7.2-alpine}"
...
readonly MINIO_TAG="${MINIO_TAG:-RELEASE.2024-12-18T13-15-44Z}"
readonly MC_TAG="${MC_TAG:-RELEASE.2024-10-08T09-37-26Z}"
